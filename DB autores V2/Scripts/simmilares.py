...
output_similares_file_path = os.path.join('..', 'output', 'autores_similares_95_2.xlsx')
...
for nombre in nombres_unicos:
    ...
    similares[nombre] = [coincidencia for coincidencia in coincidencias if coincidencia[1] > 95 and coincidencia[0] != nombre]
