# -*- coding: utf-8 -*-
"""
Created on Thu Apr 18 16:01:08 2024
...
output_file_path = os.path.join('..', 'output', 'nombres_corregidos.xlsx')
...
df_nombres_correctos['Autor Individual'] = df_nombres_correctos['Autor Individual'].astype(str)
...
df_nombres_por_corregir['Nombre Corregido'] = df_nombres_por_corregir['Nombre autor mal'].apply(
    encontrar_coincidencia, args=(df_nombres_correctos['Autor Individual'].tolist(),))
