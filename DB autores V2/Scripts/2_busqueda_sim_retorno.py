...
output_similares_file_path = os.path.join('..', 'output', 'autores_similares_87_2.xlsx')
output_no_similares_file_path = os.path.join('..', 'output', 'autores_no_similares.xlsx')
...
for nombre in nombres_unicos:
    ...
    lista_similares = [coincidencia[0] for coincidencia in coincidencias if coincidencia[1] > 95 and coincidencia[0] != nombre]
    if lista_similares:
