...
data = "https://portalhcd.diputados.gob.mx/PortalWeb/Micrositios/723fc6d1-9b1d-44fe-a05e-ab6067047f75.pdf"
...
file_path = os.path.join(output_dir, 'curso_sistema_alta_densidad.svg')
